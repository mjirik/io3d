...
class PathManipulationTest(unittest.TestCase):
    ...
    def test_save_image_stack_with_unique_series_number_based_on_filename1(self):
        ...
        series_number = io3d.datawriter.get_unoccupied_series_number(
            filepattern=filepattern
        )
        out = io3d.datawriter.filepattern_fill_series_number(
            filepattern, series_number=15
        )
    ...
    def test_fill_series_number_delete(self):
        ...
        out = io3d.datawriter.filepattern_fill_series_number(
            "{seriesn:03d}/{slicen:06d}", series_number=""
        )
    ...
    def test_fill_slice_number_delete(self):
        ...
        out = io3d.datawriter.filepattern_fill_slice_number_or_position(
            "{seriesn:03d}/ra{slicen:06d}.jpg", ""
        )
    ...
    def test_fill_slice_number(self):
        ...
        out = io3d.datawriter.filepattern_fill_slice_number_or_position(
            "{seriesn:03d}/ra{slice_number:06d}.jpg", 10
        )
