...
latex_documents = [
    (master_doc, 'io3d.tex', u'io3d Documentation',
     u'Miroslav Jirik', 'manual'),
]
...
man_pages = [
    (master_doc, 'io3d', u'io3d Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'io3d', u'io3d Documentation',
     author, 'io3d', 'One line description of project.',
     'Miscellaneous'),
]
